...
#                        new_reclamacao GET    /reclamacoes/new(.:format)                                                               reclamacoes#new
#                       edit_reclamacao GET    /reclamacoes/:id/edit(.:format)                                                          reclamacoes#edit
#                            reclamacao GET    /reclamacoes/:id(.:format)                                                               reclamacoes#show
...
#                           visit_index GET    /visit/index(.:format)                                                                   visit#index
#                            home_index GET    /home/index(.:format)                                                                    home#index
#                         welcome_index GET    /welcome/index(.:format)                                                                 welcome#index
#                                  root GET    /                                                                                        reclamacoes#index
