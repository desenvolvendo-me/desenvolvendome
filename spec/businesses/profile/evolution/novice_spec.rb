...
RSpec.describe "Profile::Evolution::Novice" do
  ...
  context "level" do
    ...
    it "1" do
      ...
      expect(@user.profile.evaluation.xp).to eq(1403)
    ...
    it "2" do
      ...
      expect(@user.profile.evaluation.novice?).to be_truthy
      expect(@user.profile.evaluation.xp).to eq(1481)
    ...
    it "8" do
      ...
      expect(@user.profile.evaluation.novice?).to be_truthy
      expect(@user.profile.evaluation.xp).to eq(3117)
    ...
    it "10" do
      ...
      expect(@user.profile.evaluation.novice?).to be_truthy
      expect(@user.profile.evaluation.xp).to eq(4442)
