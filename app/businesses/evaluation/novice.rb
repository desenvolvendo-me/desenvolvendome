class Evaluation::Novice
  ...
  SETTING = {min_level: 1, max_level: 10, role: {kind: :novice, calc: 30, repositories: 3, commits: 300, repository_size: 100, commits_preview: 150}}
  ...
  def up?
    (repositories >= SETTING[:role][:repositories] and commits >= SETTING[:role][:commits])
  end
