class Evaluation::Disciplinarian
  ...
  def commits_index
    ...
    commits_1000 = repositories.where("commits_count >= 1000 and commits_count < 2000").count
    commits_2000 = repositories.where("commits_count >= 2000 and commits_count < 5000").count
